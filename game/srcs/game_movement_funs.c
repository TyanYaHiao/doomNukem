...
/*   Updated: 2019/12/16 22:43:49 by zytrams          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (eng->edit && abs(eng->world->sectors_array[sect].floor) < 8000
...
{
	if (eng->edit && abs(eng->world->sectors_array[sect].ceil) < 8000
